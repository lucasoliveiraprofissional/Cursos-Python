...
'''Fiz versão b pois não tive ideia de como ele
poderia ler um valor desse modo'''
...
'''Interessante como uma variável recebe o valor de uma função: n= str(input(msg))'''
