...
'''Peguei no Youtube a resposta, por preguiça, peguei o que mais gostei,
o mais simples, parecido com o que eu faria, enxuto.'''
...
print('')
print('-------------------------------------')
print('| PROGRAMA PARA COMPUTAÇÃO DE VOTOS |')
print('|   Digite seu voto em um jogador   |')
print('|Entre 1 ou 23 ou digite 0 para sair|')
print('-------------------------------------')
print('')

num = int(input('Digite seu voto: '))
...
print('\nQuantidade de votos computados : {}'.format(len(voto)))

mais = 1

for i in range(1, 24):
    totaldevotosi = voto.count(i)
    if totaldevotosi > mais:
        mais = i
    if totaldevotosi > 0:
        print('Jogador {} total de votos {} Porcentagem {:.2f}%'.format(i, totaldevotosi, 100*totaldevotosi/len(voto)))

print('\nO jogador mais votado foi: {}'.format(mais))