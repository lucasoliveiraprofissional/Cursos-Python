...
'''Peguei o jogo pronto do proprio autor, não consegui imaginar tamanha complexidade'''
...
def VerificaJogada(pos, zero_pos):
    ...
    if linha < 1 or linha > 4 or coluna < 1 or coluna > 4:
        ...
        if (linha == linha_zero - 1 and coluna == coluna_zero) or (
                linha == linha_zero and (coluna == coluna_zero - 1 or coluna == coluna_zero + 1)) or (
