...
Pior nota: 7.5
Média: 9,04
Aqui ele colocou vírgula errado, pq no código dele aparece . para dividir casas decimais.

Tente colocar a impressão do resultado em um único print

Fiz versão b para ter salvo o código dele apenas e saber como ele fez.
"""
