...
Fiz versão b pois não deu certo, creio que chamou uma função que deveria ter retorno.

O programa deveria solicitar respostas somente em s ou n, foi o que o meu fez no while.
'''
