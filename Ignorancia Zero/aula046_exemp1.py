...
def Formata1(i, palavra, lmt, saida):
    if len(palavra) <= lmt:
        ...
        '''O elemento da lista vai ser igual a ele (1 - para o 1º e assim por diante), + nome do carro + 
        limite= 16 conforme ele estipulou) que vai subtrair o tamanho da palavra e vai
        preencher o resto com " ", por isso o * " "+ saidas(é a lista de saídas), que pode ser 1 - na primeira'''

        '''A nesse código, a saída que é 1 - está recebendo gol + 13 " " espaços. Ficando assim:
        "1 - gol             ". '''

        '''Antes da chamada ao Formata1, o conteudo de cada saída é apenas 1 - '''
